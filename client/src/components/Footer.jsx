                ...
                <div className="grid grid-cols-4 gap-8 mb-12">
                    ...
                    <div>
                        <Link to="/" className="inline-flex items-center space-x-2 group mb-6">
                            <div className="w-10 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center transform group-hover:scale-110 transition-transform duration-200">
                                <span className="text-2xl font-black text-white">T</span>
                            </div>
                            <span className="text-xl font-bold text-white tracking-tight">Talento</span>
                        </Link>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link to="/features" className="text-gray-300 hover:text-white transition-colors text-sm block">
                                    Features
                                </Link>
                            </li>
                            <li>
                            ...
                            <li>
                                <Link to="/sample-report" className="text-gray-300 hover:text-white transition-colors text-sm block">
                                    Sample Report
                                </Link>
                            </li>
                        </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li>
                                <Link to="/cookies" className="text-gray-300 hover:text-white transition-colors text-sm block">
                                    Cookie Policy
                                </Link>
                            </li>
                        </ul>
